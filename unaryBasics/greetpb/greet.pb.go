...
var file_greet_greet_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x07, 0x67, 0x72, 0x65, 0x65, 0x74, 0x70, 0x62, 0x22, 0x2d, 0x0a, 0x0c,
	...
	0x52, 0x09, 0x66, 0x69, 0x72, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x27, 0x0a, 0x0d, 0x47,
...
func file_greet_greet_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_greet_greet_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_greet_greet_proto_msgTypes[1].Exporter = func(v any, i int) any {
